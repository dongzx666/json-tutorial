...
static void lept_stringify_string(lept_context *c, const char *s, size_t len) {
  ...
  for (i = 0; i < len; ++i) {
    ...
    case '\\':
      PUTS(c, "\\\\", 2);
      break;
    /* TODO(fengyu): why not same with before, is \\/ or / ? [02-11-21] */
    /**https://github.com/miloyip/json-tutorial/issues/51*/
    /**https://github.com/miloyip/json-tutorial/issues/82*/
    /**case '/':
      PUTS(c, "\\/", 2);
      break;*/
    case '\b':
    ...
    case '\t':
      ...
      break;
    default:
      /**https://github.com/miloyip/json-tutorial/issues/121*/
      if (temp < 0x20) {
        /* TODO(fengyu): why 7 then 6 [02-11-21] */
        char buf[7];
        sprintf(buf, "\\u%04X", temp);
        PUTS(c, buf, 6);
      } else {
        PUTC(c, s[i]);
      }
